...
public class Block {
	...
	public static final Block oreAmber = (new BlockAmberOre(100, 33, Material.rock)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setBlockName("oreAmber");
	public static final BlockFlower plantblue = (BlockFlower)(new BlockFlower(101, 30)).setHardness(0.0F).setStepSound(soundGrassFootstep).setBlockName("flowerBlue");
