...
public class Block {
	...
	public static final Block brickBright = (new BlockBrickBright(98, 77, Material.rock)).setHardness(2.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("brickBright");
	public static final Block brightglass = (new BlockBrightGlass(4, 16, Material.rock)).setHardness(2.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("brightglass");
